...
If you want to go further and experiment with more advanced outlines, like silhouettes or detailed drawings, you can import custom shapes using DXF files. You can get surprisingly creative with PCB outlines.
