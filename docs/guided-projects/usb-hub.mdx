...
- For USB-C downstream ports, wire them the same way as the upstream port, **except** you’ll need to add **5.6 kΩ pull-up resistors on the CC pins** instead of pull-downs.
...
So for each downstream USB-C port, place a **5.6 kΩ resistor** on the CC1 and CC2 pins, orient it pointing up, and wire the other end to **+5 V**.
...
![img](/docs-assets/guided-projects/usb-hub/zen_FFMfDI7HfY.webp)
...
![img](/docs-assets/guided-projects/usb-hub/zen_At1Ew0Cgyv_1.webp)
...
![img](/docs-assets/guided-projects/usb-hub/zen_nKM5G6KMHf.webp)
...
![img](/docs-assets/guided-projects/usb-hub/img-20260319164729.webp)
...
![img](/docs-assets/guided-projects/usb-hub/img-20260319164749.webp)

A dialog will pop up. Here, you need to do two main things. First, set the **Import Layer** to **Board Outline Layer**.

![img](/docs-assets/guided-projects/usb-hub/img-20260319164813.webp)

Second, adjust the **Scaling Ratio** so that the imported shape is under 100×100 mm.

<video src="/docs-assets/guided-projects/usb-hub/20260319-dxf-import.webm" autoplay muted loop playsinline></video>
...
<video src="/docs-assets/guided-projects/usb-hub/20260319-dxf-cleanup.webm" autoplay muted loop playsinline></video>

You're all done! You've successfully imported a custom shape as your board outline :D

![img](/docs-assets/guided-projects/usb-hub/img-20260319164909.webp)
