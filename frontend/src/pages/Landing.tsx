    ...
    <div className="w-screen h-full flex flex-col justify-center bg-blue overflow-hidden">
      ...
      <section className="relative w-full min-h-svh md:h-[120vh] flex flex-col items-center pt-4 md:p-5 gap-4">
        ...
        <div className="z-1 flex flex-col items-center w-full px-4 md:px-0 mt-6 sm:mt-14 xl:mt-24 gap-3 sm:gap-4">
          ...
          <Frame className="w-full max-w-[calc(100%-1rem)] sm:max-w-150 ml-1">
            ...
            >
              <input
                className="flex-1 min-w-0 py-2 md:py-3 text-lg sm:text-xl md:text-3xl placeholder-brown outline-none"
                type="email"
                value={email}
          ...
          >
            {[
              ...
              <li key={i} className="flex items-center">
                <span className="mx-6 sm:mx-10 text-2xl sm:text-4xl">
                  {item}
                </span>
              </li>
            ))}
      ...
      <section className="text-white text-center flex flex-col justify-between">
        ...
        <div className="relative min-h-[30vh] flex flex-col items-center justify-center text-center gap-4 px-4">
          <span className="tracking-[5%] text-4xl sm:text-6xl md:text-8xl font-bold">
            SHENZHEN
          </span>
        ...
        <div className="relative w-full h-24 sm:h-40 overflow-x-hidden">
          ...
          <img
            src="/clouds/1.webp"
            alt=""
            className="absolute bottom-0 left-1/4 sm:left-40 h-20 sm:h-30 z-0"
          />
          <img
            src="/clouds/2.webp"
            alt=""
            className="absolute bottom-0 right-1/4 h-20 sm:h-30 z-0"
          />
          <img
            src="/clouds/3.webp"
            alt=""
            ...
            >
              {section.id === "overview" && (
                <>
                  ...
                  <p>
                    <strong>
                      Build any hardware project you want. We’ll fund the parts.
                    </strong>{" "}
                    Level up your hardware skills. Join us for a 7-day hardware
                    hackathon in Shenzhen.
                  </p>
                  <p>
                    (← click on the tabs{" "}
                    <span className="hidden md:inline">on the left</span>
                    <span className="inline md:hidden">up top</span> to learn
                    more!)
                  </p>
                </>
              )}
              {section.id === "qualifying" && (
                <>
                  ...
                  <p>
                    Spend 60h designing and building hardware projects to get
                    invited to Fallout!
                  </p>
                  ...
                  <ol className="list-decimal list-outside ml-7 space-y-1">
                    ...
                    <li>
                      Track your time through timelapses/screen recordings &
                      journals
                    </li>
                    <li>
              ...
              {section.id === "requirements" && (
                <>
                  ...
                  <p>
                    Build a hardware project you’ve always wanted to make. We
                    value effort more than technical ability. It can be really
                    simple, but the end result should feel closer to a product
                    than a demo, a breadboarded project doesn’t count.
                  </p>
                  <p>
                    We’re not here to fund you to build a PC. Your goal is to
                    design something really cool from the ground up, and not to
                    assemble expensive parts others have made.
                  </p>
                  <p>
                    Don’t know what to build, or what counts? You’ll be part of
                    a greater community where you can ask for help!
                  </p>
                </>
              )}
              {section.id === "shipping" && (
                <>
                  ...
                  <p>
                    Shipping is making your project <em>real</em>. Putting it
                    out into the world and making it re-creatable for someone
                    else. For Fallout, you need to:
                  </p>
                  <ol className="list-decimal pl-7">
                    ...
                    <li>
                      Publish all files so it’s easily accessible & organized
                    </li>
                  </ol>
                  <p>
                    When you make your repository nothing but a dump of files
                    and 2 sentences for a README — it’s hard for people to
                    recognize your work or learn from it. It only lives in your
                    head.
                  </p>
                </>
              )}
              {section.id === "travel" && (
                <>
                  ...
                  <p>
                    We’ll be releasing more information about the logistics and
                    schedule of the event closer to July.
                  </p>
                </>
              )}
              {section.id === "parents" && (
                <>
                  ...
                  <p>
                    We understand that letting your teen travel to a foreign
                    country can be intimidating. You probably have a lot of
                    questions, and are wondering if this is a good idea. We'll
                    be releasing a parent's guide closer to the event.
                  </p>
                  <p>
                    We completely understand your worries, and we want to do
                    everything we can to help you feel more comfortable. We have
                    experience running programs very similar to this, and would
                    be happy to answer any questions over a Zoom call!
                  </p>
                  <p>
                    Hack Club operates on the principle of radical transparency
                    and we promise to communicate with you frequently and
                    transparently.
                  </p>
                  <p>
